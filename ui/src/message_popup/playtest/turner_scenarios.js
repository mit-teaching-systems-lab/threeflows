...
export const TurnerScenarios = {
  ...
  getSlides() {
    ...
    slides.push({type: 'Background', stage: 'info', text: 
      `Imagine you are a new teacher recently hired to work at Pleasantville High School, a small, suburban school within 1 hour’s drive of a major metropolitan city. You are beginning the second semester of your first year of teaching at Pleasantville HS. You've established an overall solid rapport with your students, as they recognize you as a teacher who is fair, consistent, knowledgeable, and has high expectations for student achievement.

One of your courses is a general course for 11th grade students. As a teacher, you believe that all students can learn. You structure your classes such that you support students as they grow intellectually while always keeping the academic pressure on, challenging them to continue advancing and to not become passive, stagnant individuals who just show up for class. This philosophy translates to a variety of independent in-class and out-of-class assignments. Never a fan of long lectures or worksheets, you structure most classes with a combination of mini-lectures, independent and group readings, and in-class projects/assignments. At times, students show frustration with the variety of learning activities. Some students appear to be more comfortable with you simply telling them what they will need to know, instead of challenging them to discover and construct knowledge themselves.
