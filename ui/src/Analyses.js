...
import LATEST_CONSENT from '../public/PRIVATE_SENSITIVE_DATA/consent-teacher-moments/consented-latest.json';
import HMTCA_PAPER_CONSENT from '../public/PRIVATE_SENSITIVE_DATA/consent-teacher-moments/consented-hmtca-paper.json';
const LATEST_DB_PATH = '/PRIVATE_SENSITIVE_DATA/db/db-latest.json';
const LATEST_S3_PATH = '/PRIVATE_SENSITIVE_DATA/s3/2018-01-29/';
