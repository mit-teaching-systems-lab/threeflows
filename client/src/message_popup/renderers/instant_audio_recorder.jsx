...
export default class extends React.Component {
  ...
  static displayName = 'InstantAudioRecorder';

  static propTypes = {
    url: PropTypes.string.isRequired,
    onDoneUploading: PropTypes.func.isRequired,
    onLogMessage: PropTypes.func.isRequired,
    instantRecord: PropTypes.bool,
    recordingPrompt: PropTypes.string,
